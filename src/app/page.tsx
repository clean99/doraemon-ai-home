...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-12 w-full">
      ...
      <Image className="mb-4 header-logo" src="/logo.jpeg" alt="logo" width={124} height={124} />
     <h1 className="text-5xl font-bold mb-4" >
        Next Generation
        <div className="flex items-center text-blue-600">
          Doraemon AI <Image className="ml-4 text-logo" src="/logo.jpeg" alt="logo" width={64} height={64} />
        </div>
     </h1>
